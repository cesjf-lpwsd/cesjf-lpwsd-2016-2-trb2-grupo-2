...
import academiaPoliesportiva.bean.MensalidadeFacade;
...
public class MensalidadeController implements Serializable {
    ...
    @EJB
    private academiaPoliesportiva.bean.MensalidadeFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Mensalidade) getItems().getRowData();
    ...
    public Mensalidade getMensalidade(java.lang.Long id) {
    ...
    public Mensalidade getCurrent() {
        return current;
    }

    public void setCurrent(Mensalidade current) {
